      ...
      <main className="container mx-auto px-4 py-8 sm:py-16 min-h-screen">
        <div className="max-w-3xl mx-auto bg-background/40 backdrop-blur-md p-8 rounded-3xl border border-white/10">
          ...
          <div className="space-y-6 text-muted-foreground prose prose-invert">
            ...
            <h2 className="text-2xl font-bold font-headline text-foreground pt-4">
              <TypewriterText text="1. Information we collect" />
            </h2>
            <p>
            ...
            <h2 className="text-2xl font-bold font-headline text-foreground pt-4">
              <TypewriterText text="2. Legal bases for processing" />
            </h2>
            <p>
            ...
            <h2 className="text-2xl font-bold font-headline text-foreground pt-4">
              <TypewriterText text="3. Security of your personal information" />
            </h2>
            <p>
            ...
            <h2 className="text-2xl font-bold font-headline text-foreground pt-4">
              <TypewriterText text="4. Your rights and controlling your personal information" />
            </h2>
            <p>
